...
const getUser=()=>{
  ...
  let params = {
    ...
    size: Data.pageSize,
    user_id:Data.yh_user_id_str ,//可以匹配多个字段
    user_phone:Data.yh_user_phone_str ,//可以匹配多个字段
    source:Data.yh_source_str,
    track_id:Data.yh_track_id_str,
  }
  // axios请求
  Api.consult_yhuser.getAll(params)
      .then((res) =>{
        // 判断是否成功
        console.log('成功',res)
        if (res.status === 200){
          Data.consultyhuser = res.data.results.sort((a, b) => new Date(b.utime).getTime() - new Date(a.utime).getTime()) //这是升序，倒序的话翻过来
...
const listAllUser=()=>{
  //清除查询数据
  Data.yh_user_id_str = "";
  Data.yh_user_phone_str = "";
  Data.yh_source_str = "";
  Data.yh_track_id_str = "";
  // 重新请求
  getUser();
}
...
<template>
  ...
  <el-form :inline="true" class="demo-form-inline" style="display: flex">
    <el-form-item label="用户UID:">
      <el-input v-model="Data.yh_user_id_str" placeholder="请输入查询的用户UID" />
    </el-form-item>
    <el-form-item label="手机号:">
      <el-input v-model="Data.yh_user_phone_str" placeholder="请输入查询的手机号" />
    </el-form-item>
    <el-form-item label="来源:">
      <el-input v-model="Data.yh_source_str" placeholder="请输入查询的来源" />
    </el-form-item>
  </el-form>
  ...
  <!-- 表格部分 -->
  <el-table :data="Data.consultyhuser" border stripe style="width: 100%"
  ...
  >
    ...
    <el-table-column prop="youhui_id" label="youhui_id" align="center" width="150" :show-overflow-tooltip="true"/>
    ...
    <el-table-column prop="ctime" :formatter="setDate" label="ctime" align="center" width="200" :show-overflow-tooltip="true"></el-table-column>
    <el-table-column prop="utime" :formatter="setDate" label="utime" align="center" width="200" :show-overflow-tooltip="true"/>
    <el-table-column prop="zid" label="zid"  align="center" width="80" :show-overflow-tooltip="true"/>
    <el-table-column prop="product_source" label="product_source"  align="center" width="80" :show-overflow-tooltip="true"/>
    ...
    <el-table-column prop="coupon_id" label="coupon_id"  align="center" width="150" :show-overflow-tooltip="true"/>
    <el-table-column prop="youhui_type" label="youhui_type" align="center" width="150" :show-overflow-tooltip="true"/>
    <el-table-column prop="business_data" label="business_data" align="center" width="150" :show-overflow-tooltip="true"/>
    <el-table-column prop="external_source" label="external_source" align="center" width="150" :show-overflow-tooltip="true"/>
