...
const getUser=()=>{
  ...
  let params = {
    ...
    size: Data.pageSize,
    uuid:Data.gz_uuid_str ,//可以匹配多个字段
    phone:Data.gz_phone_str,
    operate:Data.gz_operate_str,
  }
  // axios请求
  Api.userfocus_uuid.getAll(params)
      .then((res) =>{
        // 开启loading
        openLoading()
        // 判断是否成功
        if (res.status === 200){
          // 关闭loading
          closeLoading()
          Data.userfocusuuid = res.data.results.sort((a, b) => new Date(b.ctime).getTime() - new Date(a.ctime).getTime()) //这是升序，倒序的话翻过来
...
<template>
  ...
  <el-form :inline="true" class="demo-form-inline" style="display: flex">
    <el-form-item label="用户UID:">
      <el-input v-model="Data.gz_uuid_str" placeholder="请输入查询的用户UUID" />
    </el-form-item>
    <el-form-item label="手机号:">
      <el-input v-model="Data.gz_phone_str" placeholder="请输入查询的手机号" />
    </el-form-item>
    <el-form-item label="是否关注:">
      <el-input v-model="Data.gz_operate_str" placeholder="请输入查询的来源" />
    </el-form-item>
  </el-form>
  ...
  <!-- 表格部分 -->
  <el-table :data="Data.userfocusuuid" border stripe style="width: 100%"
            :header-cell-style="{backgroundColor:'#409Eff',color:'#FFF',fontSize:'14px'}"
  >
    <el-table-column type="index" label="序号" width="45"></el-table-column>
    <el-table-column prop="ids"  label="id" align="center" width="80" :show-overflow-tooltip="true"></el-table-column>
    <el-table-column prop="mid"  label="mid" align="center" width="200" :show-overflow-tooltip="true"></el-table-column>
    <el-table-column prop="uuid" label="uuid" align="center" width="200" :show-overflow-tooltip="true"/>
    ...
    <el-table-column prop="operate" label="operate"  align="center" width="150" :show-overflow-tooltip="true"/>
    <el-table-column prop="hid" label="hid"  align="center" width="150" :show-overflow-tooltip="true"/>
    <el-table-column prop="site" label="site" align="center" width="150" :show-overflow-tooltip="true"/>
    <el-table-column prop="ctime" label="ctime" :formatter="setDate" align="center" width="200" :show-overflow-tooltip="true"/>
    <el-table-column prop="kind" label="kind"  align="center" width="80" :show-overflow-tooltip="true"/>
    <el-table-column prop="pic_ids" label="pic_ids"  align="center" width="150" :show-overflow-tooltip="true"/>
    <el-table-column prop="pic_type" label="pic_type" align="center" width="150" :show-overflow-tooltip="true"/>
    <el-table-column prop="sale_info_id" label="sale_info_id" align="center" width="150" :show-overflow-tooltip="true"/>
